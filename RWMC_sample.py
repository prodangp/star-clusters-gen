...
samples = sampler.sample(goback=True, random_walk=True)
np.save(f'{model_path}/RWMC_cluster.npy', samples)
x = samples
...
ax1.set_title('RWMC', fontsize=16)
...
plt.savefig(f'{model_path}/RWMC.png')
# Show the plot
plt.show()
